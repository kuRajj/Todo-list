...
function deleteLi() {
    const bodyTodo = document.querySelector('.body');
...
function closeModalDifferently() {
...
function closeEditModalDifferently() {
...
deleDonelist();
popupOpen();
closeModalDifferently();
closeEditModalDifferently();